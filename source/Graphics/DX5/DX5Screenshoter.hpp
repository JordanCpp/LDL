...
namespace LDL
{
	namespace Graphics
	{
		class DX5Screenshoter: public LDL::Graphics::IGpuScreenshoter
		{
		public:
			DX5Screenshoter(const std::string& path, const std::string& name, LDL::Graphics::IGpuRender* render, LDL::Graphics::CpuImage* image);
			void Shot();
		private:
