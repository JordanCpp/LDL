...
void LDL_KeyMapperInit(LDL_KeyMapper* keyMapper)
{
    if (keyMapper)
    {
        ...
        LDL_KeyMappingAdd(&keyMapper->Mapping, 'B', LDL_KeyB);
        LDL_KeyMappingAdd(&keyMapper->Mapping, 'C', LDL_KeyC);
        LDL_KeyMappingAdd(&keyMapper->Mapping, 'L', LDL_KeyL);
        LDL_KeyMappingAdd(&keyMapper->Mapping, 'M', LDL_KeyM);
        LDL_KeyMappingAdd(&keyMapper->Mapping, 'N', LDL_KeyN);
        LDL_KeyMappingAdd(&keyMapper->Mapping, 'V', LDL_KeyV);
        LDL_KeyMappingAdd(&keyMapper->Mapping, 'X', LDL_KeyX);
    }
}
