...
{
    LDL_Color   srcColor = LDL_2DRenderOpenGL1GetColor(render);
...
void LDL_2DRenderOpenGL1Draw(LDL_2DRenderOpenGL1* render, LDL_TextureOpenGL* texture, LDL_Vec2i* dstPos, LDL_Vec2i* dstSize, LDL_Vec2i* srcPos, LDL_Vec2i* srcSize)
{
    if (render)
    {
        LDL_BufferOpenGLAddTexture(&render->Buffer, LDL_2DRenderOpenGL1GetLayer(render), texture, dstPos, dstSize, srcPos, srcSize, texture->Quad);
    }
}
...
void LDL_2DRenderOpenGL1Line2i(LDL_2DRenderOpenGL1* render, LDL_Vec2i first, LDL_Vec2i last)
{
    if (render)
    {
        LDL_BufferOpenGLAddLine(&render->Buffer, LDL_2DRenderOpenGL1GetColor(render), LDL_2DRenderOpenGL1GetLayer(render), first, last);
    }
}
...
void LDL_2DRenderOpenGL1Fill2i(LDL_2DRenderOpenGL1* render, LDL_Vec2i first, LDL_Vec2i last)
{
    if (render)
    {
        LDL_BufferOpenGLAddFill(&render->Buffer, LDL_2DRenderOpenGL1GetColor(render), LDL_2DRenderOpenGL1GetLayer(render), first, last);
    }
}
