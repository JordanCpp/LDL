...
void LDL_2DRenderOpenGL2Init(LDL_2DRenderOpenGL2* render, LDL_Result* result, LDL_Window* window)
{
    if (!render) return;
...
void LDL_2DRenderOpenGL2Deinit(LDL_2DRenderOpenGL2* render)
{
    if (render)
    {
...
size_t LDL_2DRenderOpenGL2GetLayer(LDL_2DRenderOpenGL2* render)
{
    if (render)
    {
...
void LDL_2DRenderOpenGL2SetLayer(LDL_2DRenderOpenGL2* render, size_t layer)
{
    if (render)
    {
...
LDL_Color LDL_2DRenderOpenGL2GetColor(LDL_2DRenderOpenGL2* render)
{
    return LDL_BaseRenderGetColor(&render->BaseRender);
}

void LDL_2DRenderOpenGL2SetColor(LDL_2DRenderOpenGL2* render, LDL_Color color)
{
    LDL_BaseRenderSetColor(&render->BaseRender, color);
}

void LDL_2DRenderOpenGL2Clear(LDL_2DRenderOpenGL2* render)
{
    LDL_Color   srcColor = LDL_2DRenderOpenGL2GetColor(render);
...
void LDL_2DRenderOpenGL2Begin(LDL_2DRenderOpenGL2* render)
{
    LDL_Vec2i size;
...
void LDL_2DRenderOpenGL2End(LDL_2DRenderOpenGL2* render)
{
    size_t i;
    LDL_Batch* batch;
...
void LDL_2DRenderOpenGL2Draw(LDL_2DRenderOpenGL2* render, LDL_TextureOpenGL* texture, LDL_Vec2i* dstPos, LDL_Vec2i* dstSize, LDL_Vec2i* srcPos, LDL_Vec2i* srcSize)
{
    if (render)
    {
        LDL_BufferOpenGLAddTexture(&render->Buffer, LDL_2DRenderOpenGL2GetLayer(render), texture, dstPos, dstSize, srcPos, srcSize, texture->Quad);
    }
}

void LDL_2DRenderOpenGL2Line2i(LDL_2DRenderOpenGL2* render, LDL_Vec2i first, LDL_Vec2i last)
{
    if (render)
    {
        LDL_BufferOpenGLAddLine(&render->Buffer, LDL_2DRenderOpenGL2GetColor(render), LDL_2DRenderOpenGL2GetLayer(render), first, last);
    }
}

void LDL_2DRenderOpenGL2Fill2i(LDL_2DRenderOpenGL2* render, LDL_Vec2i first, LDL_Vec2i last)
{
    if (render)
    {
        LDL_BufferOpenGLAddFill(&render->Buffer, LDL_2DRenderOpenGL2GetColor(render), LDL_2DRenderOpenGL2GetLayer(render), first, last);
    }
}
