...
void gluMakeIdentityf(GLfloat m[16])
{
...
void gluPerspective(GLfloat fovy, GLfloat aspect, GLfloat zNear, GLfloat zFar)
{
    ...
    GLfloat radians = (GLfloat)(fovy / 2.0f * glPi / 180.0f);
...
void gluMultMatrixVecf(const GLfloat matrix[16], const GLfloat in[4],
    GLfloat out[4])
{
    int i;
...
*/
static int gluInvertMatrixf(const GLfloat m[16], GLfloat invOut[16])
{
    GLfloat inv[16], det;
    int i;
