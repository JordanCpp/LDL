...
void PixelCopier::Copy(uint8_t* dstPixels, size_t dstFormat, const Vec2u& dstArea, const Vec2u& dstPos, const Vec2u& dstSize, uint8_t* srcPixels, size_t srcFormat, const Vec2u& srcArea, const Vec2u& srcPos, const Vec2u& srcSize)
{
	switch (dstFormat)
	{
...
void PixelCopier::RGB24FromRGB24(uint8_t* dstPixels, const Vec2u& dstArea, const Vec2u& dstPos, const Vec2u& dstSize, uint8_t* srcPixels, const Vec2u& srcArea, const Vec2u& srcPos, const Vec2u& srcSize)
{
...
void PixelCopier::RGB24FromRGBA32(uint8_t* dstPixels, const Vec2u& dstArea, const Vec2u& dstPos, const Vec2u& dstSize, uint8_t* srcPixels, const Vec2u& srcArea, const Vec2u& srcPos, const Vec2u& srcSize)
{
	size_t dstBpp = BytesPerPixelFromPixelFormat(PixelFormat::RGB24);
...
void PixelCopier::CopyRGBA32ToRGB24(uint8_t* srcPixels, const Vec2u& srcSize, Surface* srcSurf, uint8_t* dstPixels, const Vec2u& dstSize, const Vec2u& pos, Surface* dstSurf)
{
	LDL_UNUSED(srcSurf);
	LDL_UNUSED(dstSurf);
