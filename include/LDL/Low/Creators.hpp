...
LDL_LIBRARY LDL_ITexture* LDL_TextureCreate(LDL_IRenderContext* renderContext, const LDL_Vec2u& size, uint8_t* pixels, uint8_t bpp);
...
LDL_LIBRARY LDL_ISurface* LDL_SurfaceCreate(LDL_IRenderContext* renderContext, LDL_IWindow* window, const LDL_Vec2u& size, uint8_t bpp);
LDL_LIBRARY LDL_ISurface* LDL_SurfaceCreate(LDL_IRenderContext* renderContext, LDL_IWindow* window, const LDL_Vec2u& size, uint8_t LDL_FAR* bytes, uint8_t bpp);
...
LDL_LIBRARY LDL_IWindow* LDL_WindowCreate(LDL_IRenderContext* context, const LDL_Vec2u& pos, const LDL_Vec2u& size, const char* title, size_t mode);
