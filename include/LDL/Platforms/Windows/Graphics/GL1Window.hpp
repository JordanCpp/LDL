...
namespace LDL
{
	namespace Graphics
	{
		namespace Windows
		{
			...
			{
			public:
				GL1Window(const LDL::Graphics::Point2u& pos, const LDL::Graphics::Point2u& size, const std::string& title, LDL::Enums::WindowMode mode = LDL::Enums::WindowMode::Resized);
				~GL1Window();
				void Present();
