 ...
 *
 ***************************************************************************/
#ifndef LDL_DirectX_DirectX6_d3dtypes_hpp
#define LDL_DirectX_DirectX6_d3dtypes_hpp
...
#define RGB_TORGBA(rgb)        ((D3DCOLOR) ((rgb) | 0xff000000))
             ...
             */
              ...
              */
        const DWORD  D3DENUMRET_CANCEL = DDENUMRET_CANCEL;

        /*
         * Continue the enumeration
         */
        const DWORD  D3DENUMRET_OK = DDENUMRET_OK;

        typedef HRESULT(LDL_API_CALL* LPD3DVALIDATECALLBACK)(LPVOID lpUserArg, DWORD dwOffset);
        typedef HRESULT(LDL_API_CALL* LPD3DENUMTEXTUREFORMATSCALLBACK)(LPDDSURFACEDESC lpDdsd, LPVOID lpContext);
        typedef HRESULT(LDL_API_CALL* LPD3DENUMPIXELFORMATSCALLBACK)(LPDDPIXELFORMAT lpDDPixFmt, LPVOID lpContext);
         ...
         */
        const DWORD  D3DCLIP_LEFT = 0x00000001L;
        const DWORD  D3DCLIP_RIGHT = 0x00000002L;
        const DWORD  D3DCLIP_TOP = 0x00000004L;
        const DWORD  D3DCLIP_BOTTOM = 0x00000008L;
        const DWORD  D3DCLIP_FRONT = 0x00000010L;
        const DWORD  D3DCLIP_BACK = 0x00000020L;
        const DWORD  D3DCLIP_GEN0 = 0x00000040L;
        const DWORD  D3DCLIP_GEN1 = 0x00000080L;
        const DWORD  D3DCLIP_GEN2 = 0x00000100L;
        const DWORD  D3DCLIP_GEN3 = 0x00000200L;
        const DWORD  D3DCLIP_GEN4 = 0x00000400L;
        const DWORD  D3DCLIP_GEN5 = 0x00000800L;

        /*
         * Values for d3d status.
         */
        const DWORD  D3DSTATUS_CLIPUNIONLEFT = D3DCLIP_LEFT;
        const DWORD  D3DSTATUS_CLIPUNIONRIGHT = D3DCLIP_RIGHT;
        const DWORD  D3DSTATUS_CLIPUNIONTOP = D3DCLIP_TOP;
        const DWORD  D3DSTATUS_CLIPUNIONBOTTOM = D3DCLIP_BOTTOM;
        const DWORD  D3DSTATUS_CLIPUNIONFRONT = D3DCLIP_FRONT;
        const DWORD  D3DSTATUS_CLIPUNIONBACK = D3DCLIP_BACK;
        const DWORD  D3DSTATUS_CLIPUNIONGEN0 = D3DCLIP_GEN0;
        const DWORD  D3DSTATUS_CLIPUNIONGEN1 = D3DCLIP_GEN1;
        const DWORD  D3DSTATUS_CLIPUNIONGEN2 = D3DCLIP_GEN2;
        const DWORD  D3DSTATUS_CLIPUNIONGEN3 = D3DCLIP_GEN3;
        const DWORD  D3DSTATUS_CLIPUNIONGEN4 = D3DCLIP_GEN4;
        const DWORD  D3DSTATUS_CLIPUNIONGEN5 = D3DCLIP_GEN5;

        const DWORD  D3DSTATUS_CLIPINTERSECTIONLEFT = 0x00001000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONRIGHT = 0x00002000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONTOP = 0x00004000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONBOTTOM = 0x00008000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONFRONT = 0x00010000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONBACK = 0x00020000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONGEN0 = 0x00040000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONGEN1 = 0x00080000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONGEN2 = 0x00100000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONGEN3 = 0x00200000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONGEN4 = 0x00400000L;
        const DWORD  D3DSTATUS_CLIPINTERSECTIONGEN5 = 0x00800000L;
        const DWORD  D3DSTATUS_ZNOTVISIBLE = 0x01000000L;
        /* Do not use 0x80000000 for any status flags in future as it is reserved */

        const DWORD  D3DSTATUS_CLIPUNIONALL = (\
        ...
        const DWORD  D3DSTATUS_CLIPINTERSECTIONALL = (\
         ...
         */
        const DWORD  D3DTRANSFORM_CLIPPED = 0x00000001l;
        const DWORD  D3DTRANSFORM_UNCLIPPED = 0x00000002l;
         ...
         */
         ...
         /* flags bits */
        const DWORD  D3DLIGHT_ACTIVE = 0x00000001;
        const DWORD  D3DLIGHT_NO_SPECULAR = 0x00000002;

        /* maximum valid light range */
        const float  D3DLIGHT_RANGE_MAX = ((float)sqrt(FLT_MAX));
         ...
         */
        const DWORD  D3DCOLOR_MONO = 1;
        const DWORD  D3DCOLOR_RGB = 2;
         ...
         */
        const DWORD  D3DCLEAR_TARGET = 0x00000001l; /* Clear target surface */
        const DWORD  D3DCLEAR_ZBUFFER = 0x00000002l;  /* Clear target z buffer */
        const DWORD  D3DCLEAR_STENCIL = 0x00000004l;  /* Clear stencil planes */
         ...
         */
        const DWORD  D3DSTATE_OVERRIDE_BIAS = 256;
        ...
        inline DWORD  D3DSTATE_OVERRIDE(DWORD type)
        {
            return  (D3DRENDERSTATETYPE((DWORD(type) + D3DSTATE_OVERRIDE_BIAS)));
        }

        // For back-compatibility with legacy compilations
        const DWORD  D3DRENDERSTATE_BLENDENABLE = D3DRENDERSTATE_ALPHABLENDENABLE;


        // Bias to apply to the texture coordinate set to apply a wrap to.
        const DWORD  D3DRENDERSTATE_WRAPBIAS = 128UL;

        /* Flags to construct the WRAP render states */
        const DWORD  D3DWRAP_U = 0x00000001L;
        const DWORD  D3DWRAP_V = 0x00000002L;


        inline DWORD  D3DRENDERSTATE_STIPPLEPATTERN(DWORD y)
        {
            return (D3DRENDERSTATE_STIPPLEPATTERN00 + (y));
        }
        ...
        const DWORD  D3DPROCESSVERTICES_TRANSFORMLIGHT = 0x00000000L;
        const DWORD  D3DPROCESSVERTICES_TRANSFORM = 0x00000001L;
        const DWORD  D3DPROCESSVERTICES_COPY = 0x00000002L;
        const DWORD  D3DPROCESSVERTICES_OPMASK = 0x00000007L;

        const DWORD  D3DPROCESSVERTICES_UPDATEEXTENTS = 0x00000008L;
        const DWORD  D3DPROCESSVERTICES_NOCOLOR = 0x00000010L;
...
D3DTOP_FORCE_DWORD = 0x7fffffff,
         ...
         */
        const DWORD  D3DTA_SELECTMASK = 0x0000000f;// mask for arg selector
        const DWORD  D3DTA_DIFFUSE = 0x00000000;  // select diffuse color
        const DWORD  D3DTA_CURRENT = 0x00000001; // select result of previous stage
        const DWORD  D3DTA_TEXTURE = 0x00000002; // select texture color
        const DWORD  D3DTA_TFACTOR = 0x00000003; // select RENDERSTATE_TEXTUREFACTOR

        const DWORD  D3DTA_COMPLEMENT = 0x00000010;  // take 1.0 - x
        const DWORD  D3DTA_ALPHAREPLICATE = 0x00000020; // replicate alpha to color components
         ...
         */
          ...
          */
        const DWORD  D3DTRIFLAG_START = 0x00000000L;
        //const DWORD  D3DTRIFLAG_STARTFLAT = (len(len)     /* 0 < len < 30 */
        const DWORD  D3DTRIFLAG_ODD = 0x0000001eL;
        const DWORD  D3DTRIFLAG_EVEN = 0x0000001fL;

        /*
         * Triangle edge flags
         * enable edges for wireframe or antialiasing
         */
        const DWORD  D3DTRIFLAG_EDGEENABLE1 = 0x00000100L; /* v0-v1 edge */
        const DWORD  D3DTRIFLAG_EDGEENABLE2 = 0x00000200L; /* v1-v2 edge */
        const DWORD  D3DTRIFLAG_EDGEENABLE3 = 0x00000400L; /* v2-v0 edge */
        const DWORD  D3DTRIFLAG_EDGEENABLETRIANGLE = \
        ...
        const DWORD  D3DSETSTATUS_STATUS = 0x00000001L;
        const DWORD  D3DSETSTATUS_EXTENTS = 0x00000002L;
        const DWORD  D3DSETSTATUS_ALL = (D3DSETSTATUS_STATUS | D3DSETSTATUS_EXTENTS);
        ...
        const DWORD  D3DCLIPSTATUS_STATUS = 0x00000001L;
        const DWORD  D3DCLIPSTATUS_EXTENTS2 = 0x00000002L;
        const DWORD  D3DCLIPSTATUS_EXTENTS3 = 0x00000004L;
         ...
         */
        const DWORD  D3DEXECUTE_CLIPPED = 0x00000001l;
        const DWORD  D3DEXECUTE_UNCLIPPED = 0x00000002l;
         ...
         */
        const DWORD  D3DPAL_FREE = 0x00;  /* Renderer may use this entry freely */
        const DWORD  D3DPAL_READONLY = 0x40;   /* Renderer may not set this entry */
        const DWORD  D3DPAL_RESERVED = 0x80;  /* Renderer may not use this entry */
        ...
        const DWORD  D3DVBCAPS_SYSTEMMEMORY = 0x00000800l;
        const DWORD  D3DVBCAPS_WRITEONLY = 0x00010000l;
        const DWORD  D3DVBCAPS_OPTIMIZED = 0x80000000l;

        /* Vertex Operations for ProcessVertices */
        const DWORD  D3DVOP_LIGHT = (1 << 10);
        const DWORD  D3DVOP_TRANSFORM = (1 << 0);
        const DWORD  D3DVOP_CLIP = (1 << 2);
        const DWORD  D3DVOP_EXTENTS = (1 << 3);
        ...
        const DWORD  D3DFVF_RESERVED1 = 0x020;
        ...
        const DWORD  D3DFVF_RESERVED2 = 0xf000; // 4 reserved bits

        const DWORD  D3DFVF_VERTEX = (D3DFVF_XYZ | D3DFVF_NORMAL | D3DFVF_TEX1);
        const DWORD  D3DFVF_LVERTEX = (D3DFVF_XYZ | D3DFVF_RESERVED1 | D3DFVF_DIFFUSE | \
            D3DFVF_SPECULAR | D3DFVF_TEX1);
        const DWORD  D3DFVF_TLVERTEX = (D3DFVF_XYZRHW | D3DFVF_DIFFUSE | D3DFVF_SPECULAR | \
            D3DFVF_TEX1);
        ...
        const DWORD  D3DDP_MAXTEXCOORD = 8;
        ...
        //
        const DWORD  D3DVIS_INSIDE_FRUSTUM = 0;
        const DWORD  D3DVIS_INTERSECT_FRUSTUM = 1;
        const DWORD  D3DVIS_OUTSIDE_FRUSTUM = 2;
        const DWORD  D3DVIS_INSIDE_LEFT = 0;
        const DWORD  D3DVIS_INTERSECT_LEFT = (1 << 2);
        const DWORD  D3DVIS_OUTSIDE_LEFT = (2 << 2);
        const DWORD  D3DVIS_INSIDE_RIGHT = 0;
        const DWORD  D3DVIS_INTERSECT_RIGHT = (1 << 4);
        const DWORD  D3DVIS_OUTSIDE_RIGHT = (2 << 4);
        const DWORD  D3DVIS_INSIDE_TOP = 0;
        const DWORD  D3DVIS_INTERSECT_TOP = (1 << 6);
        const DWORD  D3DVIS_OUTSIDE_TOP = (2 << 6);
        const DWORD  D3DVIS_INSIDE_BOTTOM = 0;
        const DWORD  D3DVIS_INTERSECT_BOTTOM = (1 << 8);
        const DWORD  D3DVIS_OUTSIDE_BOTTOM = (2 << 8);
        const DWORD  D3DVIS_INSIDE_NEAR = 0;
        const DWORD  D3DVIS_INTERSECT_NEAR = (1 << 10);
        const DWORD  D3DVIS_OUTSIDE_NEAR = (2 << 10);
        const DWORD  D3DVIS_INSIDE_ = 0;
        const DWORD  D3DVIS_INTERSECT_ = (1 << 12);
        const DWORD  D3DVIS_OUTSIDE_ = (2 << 12);

        const DWORD  D3DVIS_MASK_FRUSTUM = (3 << 0);
        const DWORD  D3DVIS_MASK_LEFT = (3 << 2);
        const DWORD  D3DVIS_MASK_RIGHT = (3 << 4);
        const DWORD  D3DVIS_MASK_TOP = (3 << 6);
        const DWORD  D3DVIS_MASK_BOTTOM = (3 << 8);
        const DWORD  D3DVIS_MASK_NEAR = (3 << 10);
        const DWORD  D3DVIS_MASK_ = (3 << 12);
