...
#define RGB_TORGBA(rgb)        ((D3DCOLOR) ((rgb) | 0xff000000))
        ...
        typedef HRESULT(LDL_CALL* LPD3DVALIDATECALLBACK)(LPVOID lpUserArg, DWORD dwOffset);
        typedef HRESULT(LDL_CALL* LPD3DENUMTEXTUREFORMATSCALLBACK)(LPDDSURFACEDESC lpDdsd, LPVOID lpContext);
        typedef HRESULT(LDL_CALL* LPD3DENUMPIXELFORMATSCALLBACK)(LPDDPIXELFORMAT lpDDPixFmt, LPVOID lpContext);
