...
/********************************************************************************************************************************
												        LDL_Mat4f - functions
********************************************************************************************************************************/
LDL_Mat4f LDL_Ortho(float left, float right, float bottom, float top, float farv, float nearv);
#ifdef LDL_IMPLEMENTATION
LDL_Mat4f LDL_Ortho(float left, float right, float bottom, float top, float farv, float nearv)
{
	LDL_Mat4f result;
...
LDL_Vec2i::LDL_Vec2i(int x, int y) :
	x(x),
	y(y)
{
}
...
/********************************************************************************************************************************
														  Memory management
********************************************************************************************************************************/
void* LDL_malloc_(size_t bytes, const char* file, int line);
void LDL_free(void* ptr, const char* file, int line);

#define LDL_malloc(x) LDL_malloc_(x, __FILE__, __LINE__)
#define LDL_free(x) LDL_free_(x, __FILE__, __LINE__)
#ifdef LDL_IMPLEMENTATION
void* LDL_malloc_(size_t bytes, const char* file, int line)
{
...
void LDL_free_(void* ptr, const char* file, int line)
{
	if (ptr == NULL)
	{
...
#ifdef LDL_IMPLEMENTATION
LDL_FixedLinear::LDL_FixedLinear(size_t bytes, LDL_Allocator* allocator) :
	_Capacity(bytes),
	_Position(0),
	_Content(NULL),
...
LDL_FixedLinear::~LDL_FixedLinear()
{
	if (_Allocator)
...
void* LDL_FixedLinear::Allocate(size_t bytes)
{
	assert(bytes > 0);
...
void LDL_FixedLinear::Deallocate(void* ptr)
{
	assert(ptr != NULL);
}

size_t LDL_FixedLinear::UsedBytes()
{
	return _Position;
}

void LDL_FixedLinear::Reset()
{
	_Position = 0;
}
#endif
...
LDL_VoidFuncPtr LDL_OpenGLFunctions::Function(const char* name)
{
	...
	if (result == 0
		|| (result == (LDL_VoidFuncPtr)0x1)
		|| (result == (LDL_VoidFuncPtr)0x2)
		|| (result == (LDL_VoidFuncPtr)0x3)
		|| (result == (LDL_VoidFuncPtr)-1))
	{
...
bool LDL_MainWindow::InitHinstance()
{
...
bool LDL_MainWindow::InitWndClass()
{
...
bool LDL_MainWindow::InitAdjustRect()
{
...
#endif
#ifdef LDL_IMPLEMENTATION
#if defined(_WIN32) && defined(LDL_SUPPORT_OPENGL1)
...
#elif defined(__unix__) && defined(LDL_SUPPORT_OPENGL1)
LDL_Window::LDL_Window(LDL_Result* result, const LDL_Vec2i& pos, const LDL_Vec2i& size, const char* title, int mode = LDL_WindowMode::Resized) :
	_Result(result),
...
void LDL_OpenGLLoader::Init(size_t major, size_t minor)
{
	_Major = major;
	_Minor = minor;
...
void LDL_Render::Draw(LDL_Texture* image, const LDL_Vec2i& pos)
{
	Draw(image, pos, image->Size(), LDL_Vec2i(0, 0), image->Size());
}

void LDL_Render::Draw(LDL_Texture* image, const LDL_Vec2i& pos, const LDL_Vec2i& size)
{
	Draw(image, pos, size, LDL_Vec2i(0, 0), image->Size());
}

void LDL_Render::Draw(LDL_Texture* image, const LDL_Vec2i& dstPos, const LDL_Vec2i& srcPos, const LDL_Vec2i& srcSize)
{
	Draw(image, dstPos, srcSize, srcPos, srcSize);
}

void LDL_Render::Draw(LDL_Texture* image, const LDL_Vec2i& dstPos, const LDL_Vec2i& dstSize, const LDL_Vec2i& srcPos, const LDL_Vec2i& srcSize)
{
	assert(image);
