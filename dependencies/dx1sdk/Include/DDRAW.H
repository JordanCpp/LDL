...
#define DDLOCK_READONLY                      0x00000010 // surface will only be read from
#define DDLOCK_WRITEONLY                     0x00000020 // surface will only be written to
