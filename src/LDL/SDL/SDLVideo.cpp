...
SDL_Surface* SDL_CreateRGBSurfaceFromPixels(size_t pixelFormat, void* pixels, int width, int height, int depth, int pitch, Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
{
	...
	SDL_SurfaceDetail* surface = new SDL_SurfaceDetail(pixelFormat, LDL_Vec2u(width, height), (uint8_t*)pixels);
...
SDL_Surface* SDL_CreateRGBSurface(Uint32 flags, int width, int height, int depth, Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
{
	...
	SDL_SurfaceDetail* surface = new SDL_SurfaceDetail(LDL_PixelFormat::RGB24, LDL_Vec2u(width, height));
